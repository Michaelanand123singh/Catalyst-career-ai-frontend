...
import { BookOpen, Briefcase, Wrench, Sparkles } from "lucide-react";
...
const cards = [
  ...
  },
  {
    ...
    description: "For students who want to pursue Diploma/ITI",
    buttonText: "Start Your Assessment", 
    path: "/diploma",
  ...
  },
  {
    ...
    description: "For Skill Development Course selection",
    buttonText: "Book Your 1-1 Counselling",
    path: "/skilldevelopment",
    icon: <Wrench size={20} />,
    accent: "from-teal-800 to-emerald-600"
  },
];
  ...
  return (
    <div className="relative bg-gradient-to-br from-white via-green-50/30 to-emerald-50/50 py-20 overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-teal-200/20 to-emerald-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-green-100/10 to-teal-100/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg md:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover the right subjects and career paths with Catalyst's
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-20">
          {cards.map((card, index) => (
            ...
            >
              ...
              {/* Category Header */}
              <div className={`relative bg-gradient-to-r ${card.accent} text-white text-sm font-semibold px-4 py-3 rounded-b-2xl w-full text-center flex items-center justify-center gap-2 shadow-lg group-hover:shadow-xl transition-all duration-300`}>
        ...
        <div className="text-center relative">
          <div className="inline-block p-8 bg-gradient-to-r from-emerald-50 to-green-50 rounded-3xl shadow-xl backdrop-blur-sm border border-green-100/50 hover:shadow-2xl transition-shadow duration-300">
            <p className="text-gray-700 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              Get matched with subjects and careers that ensure long-term
              stability and growth through our{" "}
