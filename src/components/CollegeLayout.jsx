...
></div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="flex-1 text-left">
          ...
          <p className="text-lg text-gray-600">
            Get clear, personalized guidance to plan your future with confidence.
          </p>
        </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">Clarity & Confidence</h4>
      <p className="text-gray-600 text-center">
        Make informed choices about your studies and career with research-backed guidance.
      </p>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">Discover Opportunities</h4>
      <p className="text-gray-600 text-center">
        Explore education paths and career options that align with your strengths and goals.
      </p>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">Personalized Roadmap</h4>
      <p className="text-gray-600 text-center">
        Get a tailored plan designed to help you excel academically and professionally.
      </p>
    </div>
  </div>
</div>
