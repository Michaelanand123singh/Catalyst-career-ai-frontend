...
></div>
  ...
  <div className="mb-16">
    ...
    <p className="text-2xl md:text-3xl text-gray-700 font-medium max-w-4xl mx-auto leading-relaxed mb-12">
      From choosing school subjects to landing your dream job — Catalyst helps students, parents, and professionals 
      make informed choices with the power of AI + expert guidance.
    </p>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="flex-1 text-left">
          ...
          <p className="text-lg text-gray-600">
            Assessments, counselling, and AI guidance — everything you need to find your right path.
          </p>
        </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">AI + Expert Counselling</h4>
      <p className="text-gray-600 text-center">
        Blend of technology and human expertise to guide your education and career decisions.
      </p>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">Smart Path Discovery</h4>
      <p className="text-gray-600 text-center">
        From school subjects to career specialisations, discover paths aligned with your strengths.
      </p>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-100 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
      ...
      <h4 className="text-xl font-bold text-gray-900 mb-3">Future-Ready Roadmaps</h4>
      <p className="text-gray-600 text-center">
        Get customised study, career, and skill-building roadmaps designed for long-term success.
      </p>
    </div>
  </div>
</div>
